//YT Link: https://www.youtube.com/watch?v=-rWG_jQnLCY&list=PLFGoYjJG_fqo4oVsa6l_V-_7-tzBnlulT&index=73
...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void startRecording(String methodName) throws Exception {
		File file = new File("./recordings/"); //folder to save recordings
